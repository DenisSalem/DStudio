...
DSTUDIO_DEF_GL_FUN(void,            DeleteBuffers,              GLsizei n, const GLuint * buffers)
DSTUDIO_DEF_GL_FUN(void,            DeleteProgram,              GLuint program)
DSTUDIO_DEF_GL_FUN(void,            DeleteShader,               GLuint shader)
//DSTUDIO_DEF_GL_FUN(void,            DeleteTextures,             GLsizei n, const GLuint * textures)
DSTUDIO_DEF_GL_FUN(void,            DeleteVertexArrays,         GLsizei n, const GLuint *arrays)
