...
#define APPLICATION_NAME "DSANDGRAINS"
...
#define DSANDGRAINS_SAMPLE_LFO_KNOBS 4
#define DSANDGRAINS_SAMPLE_LFO_PITCH_KNOBS 4
#define DSANDGRAINS_SAMPLE_AMOUNT_PITCH_KNOBS 2
...
#define DSANDGRAINS_INSTANCE_SCROLLABLE_LIST_INDEX_OFFSET 6
