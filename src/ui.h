...
typedef enum UIElementType_t {
    ...
    DSTUDIO_UI_ELEMENT_TYPE_KNOB = 16,
    DSTUDIO_UI_ELEMENT_TYPE_LIST_ITEM = 32,
    DSTUDIO_UI_ELEMENT_TYPE_NO_TEXTURE = 64,
    DSTUDIO_UI_ELEMENT_TYPE_NO_TEXTURE_BACKGROUND = 128,
    DSTUDIO_UI_ELEMENT_TYPE_PATTERN = 256,
    DSTUDIO_UI_ELEMENT_TYPE_PATTERN_BACKGROUND = 512,
    DSTUDIO_UI_ELEMENT_TYPE_SLIDER = 1024,
    DSTUDIO_UI_ELEMENT_TYPE_SLIDER_BACKGROUND = 2048,
    DSTUDIO_UI_ELEMENT_TYPE_TEXT = 4096,
