...
#define DSTUDIO_OPEN_FILE_CHAR_PER_LINE ((int_fast32_t) (g_dstudio_viewport_width - 62) / 8)
...
#define DSTUDIO_INSTANCE_CONTEXT_INDEX  0
#define DSTUDIO_VOICE_CONTEXT_INDEX     1
#define DSTUDIO_CLIENT_CONTEXT_INDEX    2
...
#define DSTUDIO_USE_CALLBACK 1
#define DSTUDIO_DO_NOT_USE_CALLBACK 1
